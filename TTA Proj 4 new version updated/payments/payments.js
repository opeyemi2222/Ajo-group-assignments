// =========================================
// USER KEY HELPER
// Scopes localStorage keys to the logged-in
// user's email so each user has isolated data.
// =========================================
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function getPayments() {
        ...
        return JSON.parse(
            localStorage.getItem(userKey("scheduledPayments"))
        ) || [];
...
function markPaymentAsPaid(paymentId) {
    ...
    (function () {
        ...
        var contribData;
        try {
            contribData = JSON.parse(localStorage.getItem(userKey("contribData"))) || { goal: 0, history: [] };
        } catch (e) {
        ...
        contribData.history.push({
            ...
            paymentRef:   paid.id          // link back to the source payment
        });

        localStorage.setItem(userKey("contribData"), JSON.stringify(contribData));
    }());
